...
public class CustomerTest {
	public static void main(String[] args) {
		...
		Account account2 = new SavingsAccount(AccountNumGenerate.generateAccountNum(), 1000, 0.02);
		customer.addAccount(account);
		
		account2 = new CheckingAccount(AccountNumGenerate.generateAccountNum(), 1000, 1000);
